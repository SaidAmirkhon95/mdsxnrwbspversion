...
export default function ReiterCheckThreeEn() {
    ...
    <Box sx={{ display: 'grid' }}>
      ...
      >
        <FormLabel component='legend'>
          How long does the implementation of a connector typically take?
        </FormLabel>
        <Tooltip
          title='Please provide the average duration for the implementation of a connector at a customers site.'
          placement='top-start'
      ...
      <FormControl sx={{ m: 0.5, minWidth: 250 }}>
        <InputLabel id='element'>Duration</InputLabel>
        <Select
          name='dauer'
          labelId='element'
          id='someelement'
